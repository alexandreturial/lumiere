...
import 'package:lumiere/app/modules/home/presenter/page/detail_movie_page.dart';
...
class HomeModule extends Module {
  ...
  final List<Bind> binds = [
    Bind.lazySingleton(
        (i) => HomeMovieDatasourceImplementation(database: i.get())),
  ...
  final List<ModularRoute> routes = [
    ...
    ChildRoute('/detail',
        child: (context, args) => DetailMoviePage(
              movie: args.data,
            ),
